...
// import Regulations from './views/Regulations/Regulations'; // regulations
import {RefreshContextProvider} from './contexts/RefreshContext';
import { Dashboard } from '@material-ui/icons';

const Home = lazy(() => import('./views/Home'));

const Dashboard1 = lazy(() => import('./views/Dashboard1'));
...
// const SBS = lazy(() => import('./views/Sbs'));      // sbs
// const Liquidity = lazy(() => import('./views/Liquidity')); // liquidity
